...
//Name: right_hand_fkik_switch.ma
...
createNode transform -n "right_hand_fkik_switch_transform1";
createNode mesh -n "right_hand_fkik_switch_displayShape" -p "right_hand_fkik_switch_transform1";
	setAttr -k off ".v";
	setAttr -s 2 ".iog";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "right_hand_fkik_switch_displayShape.iog" ":initialShadingGroup.dsm" 
		-na;
// End of right_hand_fkik_switch.ma
