...
createNode transform -n "left_foot_fkik_switch_transform1";
createNode mesh -n "left_foot_fkik_switch_displayShape" -p "left_foot_fkik_switch_transform1";
	setAttr -k off ".v";
	setAttr -s 2 ".iog";
	setAttr ".ove" yes;
	setAttr ".ovc" 14;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "left_foot_fkik_switch_displayShape.iog" ":initialShadingGroup.dsm" -na
		;
// End of left_foot_fkik_switch.ma
